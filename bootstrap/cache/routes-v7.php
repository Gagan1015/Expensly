...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::6dy0bKeBwkg3jAwV',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      '/api/expenses/chart-data' => 
      array (
        0 => 
        array (
          0 => 
          array (
            '_route' => 'api.expenses.chart-data',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'api.expenses.category-breakdown',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.expenses.export.csv',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.reports.export.csv',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/expenses/(?|([^/]++)(?|(*:31))|reports(*:46))|/categories/([^/]++)(?|(*:77))|/a(?|pi/(?|expenses/([^/]++)(*:113)|categories/([^/]++)(*:140))|dmin/(?|users/(?|([^/]++)(?|(*:177)|/edit(*:190)|(*:198))|bulk\\-delete(*:219))|expenses/([^/]++)(?|(*:248))|categories/([^/]++)(?|/edit(*:284)|(*:292))))|/storage/(.*)(*:316))/?$}sDu',
    ),
    3 => 
    array (
      31 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:848:"function () {
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'C:\\\\Users\\\\admin\\\\OneDrive\\\\Documents\\\\expensly\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Foundation\\\\Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@exportCsv',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@exportCsv',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'expenses.export.csv',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DashboardController@updateBudget',
        'controller' => 'App\\Http\\Controllers\\DashboardController@updateBudget',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@getChartData',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@getChartData',
        'as' => 'api.expenses.chart-data',
        'namespace' => NULL,
        'prefix' => '/api',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'api/expenses/category-breakdown',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@getCategoryBreakdown',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@getCategoryBreakdown',
        'as' => 'api.expenses.category-breakdown',
        'namespace' => NULL,
        'prefix' => '/api',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@getExpenseData',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@getExpenseData',
        'as' => 'api.expenses.data',
        'namespace' => NULL,
        'prefix' => '/api',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CategoryController@getCategoryData',
        'controller' => 'App\\Http\\Controllers\\CategoryController@getCategoryData',
        'as' => 'api.categories.data',
        'namespace' => NULL,
        'prefix' => '/api',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@adminIndex',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@adminIndex',
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ExpenseController@adminExportCsv',
        'controller' => 'App\\Http\\Controllers\\ExpenseController@adminExportCsv',
        'as' => 'admin.expenses.export.csv',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CategoryController@adminIndex',
        'controller' => 'App\\Http\\Controllers\\CategoryController@adminIndex',
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DashboardController@adminReports',
        'controller' => 'App\\Http\\Controllers\\DashboardController@adminReports',
        'as' => 'admin.reports',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DashboardController@exportReportsCsv',
        'controller' => 'App\\Http\\Controllers\\DashboardController@exportReportsCsv',
        'as' => 'admin.reports.export.csv',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
